...
amr_fortess_description_path = os.path.join(
    get_package_share_directory('amr_fortess_description'))

xacro_file = os.path.join(amr_fortess_description_path,
                            'robots',
                            'amr.urdf.xacro')

urdf_path = os.path.join(amr_fortess_description_path, 
                        'robots',
                        'amr.urdf')

rviz_config_file = os.path.join(amr_fortess_description_path,  
                                'config', 
                                'amr_config.rviz')
